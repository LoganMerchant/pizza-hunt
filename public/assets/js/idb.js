...
// called 'pizza_hunt' & set it's version to one.
...
request.onsuccess = function (event) {
  ...
  // or simply established a connection, save refernce to db in global variable
...
// This will run if we attempt to submit a new pizza while offline
